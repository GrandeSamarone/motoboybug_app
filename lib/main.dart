...
import 'package:motoboybug_app/permission.dart';
import 'package:motoboybug_app/token_monitor.dart';

import 'Model/Pedido.dart';
import 'Notificacao/NotificacaoDialog.dart';
import 'menssage.dart';
import 'menssage_list.dart';
...
class _Application extends State<Application> {
  ...
  void initState() {
    ...
    //notificação quando o app ta em primeiro plano
    ...
    //notificação quando o app ta em segundo plano
  ...
  Future<void> sendPushMessage() async {
    await FirebaseMessaging.instance.subscribeToTopic('teste_app');
    if (_token == null) {
